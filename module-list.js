(function(){
    var modules={
        ...
        "panel-export-enrolled-spardac":    {url:"$H/m/export/panel-export-enrolled.html",router:1},
        "export-data":		                {url:"$H/m/export/export-data.html",Table:"export-spardac",form_module:"export-form"},
        "export-form":		                {url:"$H/m/export/export-form.html",Table:"export-spardac"},
    ...
    "participant-form":   		        {url:"$H/m/participant/participant-form.html",Table:"spardac-participant"},
        ...
        "nback2-block-data-spardac":            {url:"$H/m/neurocog/nback2-block-data.html",Table:"nback2-block-spardac",form_module:"nback2-block-form-spardac",form_block_module:"nback-block-spec-form-spardac",task_name:"2-back Block"},
        "nback2-block-form-spardac":            {url:"$H/m/neurocog/nback2-block-form.html",Table:"nback2-block-spardac",task_name:"2-back Block",form_block_module:"nback-block-spec-form-spardac"},
        "nback-block-spec-form-spardac":       {url:"$H/m/neurocog/nback-block-spec-form.html",Table:"nback-block-spec-spardac",task_name:"2-back Block Specs"},
