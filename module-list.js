(function(){
    var modules={
        ...
        "panel-export-screening-spardac":   {url:"$H/m/panel-export-screened.html",router:1},
        "panel-export-enrolled-spardac":    {url:"$H/m/panel-export-enrolled.html",router:1},
        "export-data-spardac":		        {url:"$H/m/export-data.html",Table:"export-spardac",form_module:"export-form-spardac"},
        "export-form-spardac":		        {url:"$H/m/export-form.html",Table:"export-spardac"},
